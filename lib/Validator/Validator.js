var ValidationError = require('./../ValidationError/ValidationError'),
    Assertion = require('./../Assertion/Assertion');
...
{
    config = config || {};
    this._enabled = typeof config.enabled === 'undefined' ? true : !!config.enabled;
};


Validator.prototype.assert = function(value)
{
    return new Assertion(this._enabled, value);
};
 ...
 *
 * @deprecated since v0.1.0 - use validator.assert() chain syntax instead.
 */
